...
We can see that the four curves are not parallel. This can be seen by the curves Scald and Flame crossing, as well as the divergence of all the curves over time. Therefore, this suggests a potential violation of the PH assumption for burn type (Z11).
...
```{r Schoenfield Plot for Treatment Type (Z1), fig.cap = "Schoenfield Residuals for Treatment Type (Z1) to Evaluate PH Assumption"}
...
```{r Schoenfield Plot for Gender (Z2), fig.cap = "Schoenfield Residuals for Gender (Z2) to Evaluate PH Assumption"}
...
```{r Schoenfield Plot for Race (Z3), fig.cap = "Schoenfield Residuals for Race (Z3) to Evaluate PH Assumption"}
...
```{r Schoenfield Plot for Burn Type (Z11), fig.cap = "Schoenfield Residuals for Burn Type (Z11) to Evaluate PH Assumption"}
