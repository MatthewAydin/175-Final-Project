...
- `Z11` produced a p-value of 0.038. This p-value is greater than 0.05, indicating that we fail to reject the null hypothesis. Therefore, this suggests the PH assumption is reasonable for burn type (`Z11`).
